...
from swift.common.http import (
    ...
    HTTP_CONTINUE, HTTP_INTERNAL_SERVER_ERROR, HTTP_SERVICE_UNAVAILABLE,
    HTTP_INSUFFICIENT_STORAGE, HTTP_PRECONDITION_FAILED,
    HTTP_UNPROCESSABLE_ENTITY, HTTP_CONFLICT)
...
from swift.common.swob import HTTPAccepted, HTTPBadRequest, HTTPNotFound, \
    ...
    HTTPServerError, HTTPServiceUnavailable, HeaderKeyDict, \
...
class BaseObjectController(Controller):
    ...
    def _reroute(self, policy):
        """
        Make sure the request is routed through the correct object controller
